...
execute join(['function! vital#_ika2#Bitwise#import() abort', printf("return map({'lshift32': '', 'sign_extension': '', '_vital_created': '', 'rshift': '', 'rshift32': '', 'lshift': '', 'compare': ''}, \"vital#_ika2#function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
delfunction s:_SID
" ___vital___
" bitwise operators
